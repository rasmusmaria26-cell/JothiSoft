...
export default function KataraPrasnamPage() {
  ...
  const labels = {
    ta: {
      ...
      clockDesc: "உங்களது கேள்வி நேரத்திற்கு ஏற்ப கடிகாரத்தை மாற்றவும் அல்லது தற்போதைய நேரத்தை நேரடியாக இணைக்கவும்.",
    ...
    en: {
      ...
      clockDesc: "Position the hands to match your query time or click to sync dynamically with current system time.",
      ...
      <div className="max-w-[1100px] mx-auto flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-1.5 border-b border-bg-border pb-4">
          <h1 className="text-[24px] font-semibold text-[#80c8ff] tracking-tight font-playfair flex items-center gap-2.5">
            <Clock className="text-gold-bright animate-pulse" size={24} />
            {labels.title}
          </h1>
        ...
        <AnimatePresence mode="wait">
          {!result ? (
            ...
            >
              ...
              {/* Right Side: Clock Setup */}
              <div className="lg:col-span-5 flex flex-col gap-5">
                <div className="bg-bg-card border border-bg-border rounded-xl p-5 shadow-xl flex flex-col gap-4 h-full justify-between">
                  <div className="flex flex-col gap-1">
                    <div className="flex items-center justify-between">
                      <h2 className="text-[15px] font-semibold text-[#80c8ff] tracking-wide flex items-center gap-2">
